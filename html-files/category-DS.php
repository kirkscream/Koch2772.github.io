        ...
        <div class="productslist">
            <div class="product-container">
                ...
                <div class="product-desc">
                    ...
                    $sql = "SELECT productName, description FROM product WHERE productName = 'Dragon scale';";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ?>
                            <a href="product-bronzeDS.php" class="product-title"><?php echo $row["productName"]; ?></a>
